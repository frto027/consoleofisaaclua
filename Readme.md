...
```
l local _m,_e=Input.GetMousePosition(true),nil for _,v in pairs(Isaac.GetRoomEntities()) do _e = not _e and v or (_e.Position-_m):Length()<(v.Position-_m):Length() and _e or v end _e:BloodExplode()
```
